 ...
 - ${i11}: ${e11}`, r10 && (a10 += encodeURI(i11) + "=" + encodeURI(e11));
      ...
      let tn = { addEvent: function(t10, e10, i10, s10 = {}) {
        ...
        dateFormat(t10, e10, i10) {
          ...
          if (tf(t10) && -1 !== t10.indexOf("%")) {
            ...
            tx(tp({ a: g2 ? g2[c2] : p2[c2].substr(0, 3), A: p2[c2], d: ty(a10), e: ty(a10, 2, " "), w: c2, v: (s10 == null ? void 0 : s10.weekFrom) ?? "", b: f2[r10], B: u2[r10], m: ty(r10 + 1), o: r10 + 1, y: o10.toString().substr(2, 2), Y: o10, H: ty(n10), k: n10, I: ty(n10 % 12 || 12), l: n10 % 12 || 12, M: ty(h10), p: n10 < 12 ? "AM" : "PM", P: n10 < 12 ? "am" : "pm", S: ty(l2), L: ty(d2, 3) }, z.dateFormats), function(s11, o11) {
        ...
        var _a2;
        return tL(z, "setOptions", { options: t10 }), tO(true, tE, t10), t10.time && tI.update(tE.time), t10.lang && "locale" in t10.lang && tI.update({ locale: t10.lang.locale }), ((_a2 = t10.lang) == null ? void 0 : _a2.chartTitle) && (tE.title = { ...tE.title, text: t10.lang.chartTitle }), tE;
      ...
      class e7 {
        ...
        updateTransform(t10 = "transform") {
          ...
          eU(s10) && g2.push("matrix(" + s10.join(",") + ")"), r10 && (g2.push("rotate(" + r10 + " " + (a10 ?? e10.getAttribute("x") ?? this.x ?? 0) + " " + (n10 ?? e10.getAttribute("y") ?? this.y ?? 0) + ")"), (d2 == null ? void 0 : d2.element.tagName) !== "SPAN" || (d2 == null ? void 0 : d2.foreignObject) || d2.attr({ rotation: r10, rotationOriginX: (a10 || 0) - o10, rotationOriginY: (n10 || 0) - o10 })), (eU(h10) || eU(l2)) && g2.push(`scale(${h10 ?? 1} ${l2 ?? 1})`), g2.length && !(d2 || this).textPath && ((i10 == null ? void 0 : i10.element) || e10).setAttribute(t10, g2.join(" "));
        }
      ...
      let sa = (t10, e10) => {
        var _a2;
        if (!t10.div) {
          let i10 = i9(t10.element, "class"), s10 = t10.css, o10 = i8("div", i10 ? { className: i10 } : void 0, { position: "absolute", left: `${t10.translateX || 0}px`, top: `${t10.translateY || 0}px`, ...t10.styles, display: t10.display, opacity: t10.opacity, visibility: t10.visibility }, ((_a2 = t10.parentGroup) == null ? void 0 : _a2.div) || e10);
      ...
      class s5 {
        ...
        drawCrosshair(t10, e10) {
          ...
          if (sY(this, "drawCrosshair", { e: t10, point: e10 }), t10 || (t10 = (_a2 = this.cross) == null ? void 0 : _a2.e), i10 && false !== (sW(e10) || !s10)) {
      ...
      class oy {
        ...
        render() {
          ...
          if (!t10.chart.styledMode && (v2 ? (w2.stroke = o10 || "#999999", w2["stroke-width"] = ox(e10.width, 1), e10.dashStyle && (w2.dashstyle = e10.dashStyle)) : b2 && (w2.fill = o10 || "#e6e9ff", g2 && (w2.stroke = e10.borderColor, w2["stroke-width"] = g2))), l2.zIndex = a10, M2 += "-" + a10, (y2 = t10.plotLinesAndBandsGroups[M2]) || (t10.plotLinesAndBandsGroups[M2] = y2 = n10.g("plot-" + M2).attr(l2).add()), m2 || (this.svgElem = m2 = n10.path().attr(w2).add(y2)), oc(p2)) x2 = t10.getPlotLinePath({ value: (s10 == null ? void 0 : s10.log2lin(p2)) ?? p2, lineWidth: m2.strokeWidth(), acrossPanes: e10.acrossPanes });
          else {
          ...
          }), this.eventsAdded = true), (k2 || !m2.d) && (x2 == null ? void 0 : x2.length) ? m2.attr({ d: x2 }) : m2 && (x2 ? (m2.show(), m2.animate({ d: x2 })) : m2.d && (m2.hide(), f2 && (this.label = f2 = f2.destroy()))), u2 && (oc(u2.text) || oc(u2.formatter)) && (x2 == null ? void 0 : x2.length) && t10.width > 0 && t10.height > 0 && !x2.isFlat ? (u2 = of({ align: i10 && b2 ? "center" : void 0, x: i10 ? !b2 && 4 : 10, verticalAlign: !i10 && b2 ? "middle" : void 0, y: i10 ? b2 ? 16 : 10 : b2 ? 6 : -4, rotation: i10 && !b2 ? 90 : 0, ...b2 ? { inside: true } : {} }, u2), this.renderLabel(u2, x2, b2, a10)) : f2 && f2.hide(), this;
        }
        renderLabel(t10, e10, i10, s10) {
          var _a2, _b2, _c2;
      ...
      class o7 {
        constructor(t10, e10, i10) {
          var _a2, _b2;
          this.formatPrefix = "point", this.visible = true, this.point = this, this.series = t10, this.applyOptions(e10, i10), this.id ?? (this.id = o8()), this.resolveColor(), this.dataLabelOnNull ?? (this.dataLabelOnNull = t10.options.nullInteraction), t10.chart.pointCount++, this.category = ((_b2 = (_a2 = t10.xAxis) == null ? void 0 : _a2.categories) == null ? void 0 : _b2[this.x]) ?? this.x, this.key = this.name ?? this.category, oJ(this, "afterInit");
        }
      ...
      class ry {
        ...
        runPointActions(t10, e10, i10) {
          ...
          this.unDocMouseMove || (this.unDocMouseMove = rr(s10.container.ownerDocument, "mousemove", (t11) => {
            var _a3, _b2;
            return (_b2 = (_a3 = ri[ry.hoverChartIndex ?? -1]) == null ? void 0 : _a3.pointer) == null ? void 0 : _b2.onDocumentMouseMove(t11);
      ...
      let { setLength: rv, splice: rk } = S, { fireEvent: rw, objectEach: rM, uniqueKey: rS } = tn, rT = class {
        ...
        setRow(t10, e10 = this.rowCount, i10, s10) {
          ...
          rM(o10, (a11, n10) => {
            a11 || (s10 == null ? void 0 : s10.addColumns) === false || (a11 = Array(r10)), a11 && (i10 ? a11 = rk(a11, e10, 0, true, [t10[n10] ?? null]).array : a11[e10] = t10[n10] ?? null, o10[n10] = a11);
      ...
      class an {
        ...
        init(t10, e10) {
          ...
          let a10 = o10.events;
          ((a10 == null ? void 0 : a10.click) || ((_b2 = (_a2 = o10.point) == null ? void 0 : _a2.events) == null ? void 0 : _b2.click) || o10.allowPointSelect) && (t10.runTrackerClick = true), this.getColor(), this.getSymbol(), this.isCartesian && (t10.hasCartesianSeries = true), s10.length && (i10 = s10[s10.length - 1]), this._i = ao(i10 == null ? void 0 : i10._i, -1) + 1, this.opacity = this.options.opacity, t10.orderItems("series", r8(this, s10)), ((_c2 = o10.dataSorting) == null ? void 0 : _c2.enabled) ? this.setDataSortingOptions() : this.points || this.data || this.setData(o10.data, false), r6(this, "afterInit");
        }
        is(t10) {
        ...
        update(t10, e10) {
          ...
          g2 = g2 || r10, u2 ? (p2.push.apply(p2, an.keepPropsForPoints), false !== t10.visible && p2.push("area", "graph"), i10.parallelArrays.forEach(function(t11) {
            p2.push(t11 + "Data");
          }), t10.data && (t10.dataSorting && r3(i10.options.dataSorting, t10.dataSorting), this.setData(t10.data, false))) : this.dataTable.modified = this.dataTable, t10.dataLabels && o10.dataLabels && (t10.dataLabels = this.mergeArrays(o10.dataLabels, t10.dataLabels)), t10 = ai(o10, { index: void 0 === o10.index ? i10.index : o10.index, pointStart: ((_a2 = a10 == null ? void 0 : a10.series) == null ? void 0 : _a2.pointStart) ?? o10.pointStart ?? i10.getColumn("x")[0] }, !u2 && { data: i10.options.data }, t10, h10), u2 && t10.data && (t10.data = i10.options.data), (p2 = ["dataLabelsGroup", "dataLabelsGroups", "dataLabelsParentGroups", "group", "markerGroup", "transformGroup"].concat(p2)).forEach(function(t11) {
      ...
      class aO {
        ...
        colorizeItem(t10, e10) {
          ...
          if ((t10 instanceof ah || t10 instanceof rt) && (t10.color = ((_a2 = t10.options) == null ? void 0 : _a2.legendSymbolColor) || i10), o10 == null ? void 0 : o10[e10 ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
            ...
            r10 == null ? void 0 : r10.css(aS(e10 ? this.itemStyle : i11)), a10 == null ? void 0 : a10.attr(p2({ stroke: d2 || t10.color })), n10 && n10.attr(p2(c2 && n10.isMarker ? t10.pointAttribs() : { fill: t10.color })), s10 == null ? void 0 : s10.attr(p2({ fill: h10 || t10.color, "fill-opacity": h10 ? 1 : l2 ?? 0.75 }));
          }
      ...
      class nn {
        ...
        getClipBox(t10, e10) {
          ...
          return t10 && (s10 && s10.len !== this.plotSizeX && (n10 = s10.len), o10 && o10.len !== this.plotSizeY && (h10 = o10.len), i10 && !t10.invertible && ([n10, h10] = [h10, n10])), e10 && (r10 += ((_a2 = i10 ? o10 : s10) == null ? void 0 : _a2.pos) ?? this.plotLeft, a10 += ((_b2 = i10 ? s10 : o10) == null ? void 0 : _b2.pos) ?? this.plotTop), { x: r10, y: a10, width: n10, height: h10 };
        }
      ...
      !function(t10) {
        ...
        function s10(t11, e11) {
          var _a2, _b2;
          hM(this, "initDataLabelsGroup", { index: t11, zIndex: (e11 == null ? void 0 : e11.zIndex) ?? 6 }), this.dataLabelsGroup = (_a2 = this.dataLabelsGroups) == null ? void 0 : _a2[t11];
      ...
      function hR(t10, e10, i10, s10, o10) {
        var _a2, _b2;
        let { chart: r10, options: a10 } = this, n10 = r10.inverted, h10 = ((_a2 = this.xAxis) == null ? void 0 : _a2.len) || r10.plotSizeX || 0, l2 = ((_b2 = this.yAxis) == null ? void 0 : _b2.len) || r10.plotSizeY || 0, d2 = t10.dlBox || t10.shapeArgs, c2 = t10.below ?? (t10.plotY || 0) > (this.translatedThreshold ?? l2), p2 = i10.inside ?? !!a10.stacking;
        if (d2) {
        ...
        for (let i10 of t10.series || []) if (i10.visible && ((_a2 = i10.hasDataLabels) == null ? void 0 : _a2.call(i10))) {
          let s10 = (i11) => {
            for (let s11 of i11) s11.visible && (s11.dataLabels || []).forEach((i12) => {
              var _a3;
              let o10 = i12.options || {};
              i12.labelrank = lM(o10.labelrank, s11.labelrank, (_a3 = s11.shapeArgs) == null ? void 0 : _a3.height), o10.allowOverlap ?? Number(o10.distance) > 0 ? (i12.oldOpacity = i12.opacity, i12.newOpacity = 1, lS(i12, t10)) : e10.push(i12);
            });
          };
