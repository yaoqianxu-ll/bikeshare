  ...
  <div class="ai-chat-button" :class="{ 'ai-chat-button--open': isOpen }">
    ...
    >
      <span class="ai-chat-button__icon-wrapper">
        <!-- 机器人图标 -->
        <svg class="ai-icon-out" viewBox="0 -19.5 164 164" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- 关闭图标 -->
        <svg class="ai-icon-in" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
...
.ai-chat-button__icon-wrapper svg {
  position: absolute;
