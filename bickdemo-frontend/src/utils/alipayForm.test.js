...
test('parseAlipayForm normalizes escaped ampersands without decoding named URL entities', () => {
  const payFormHtml = [
    '<form method="post" action="https://openapi-sandbox.dl.alipaydev.com/gateway.do?sign_type=RSA2&amp;timestamp=2026-05-31+20%3A46%3A17&amp;version=1.0">',
  ...
  assert.equal(parsed.action, 'https://openapi-sandbox.dl.alipaydev.com/gateway.do?sign_type=RSA2&timestamp=2026-05-31+20%3A46%3A17&version=1.0')
})
